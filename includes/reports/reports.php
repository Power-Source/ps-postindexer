	...
	function page_output() {
		...
		switch( $action ) {
			...
			default:
				...
				<h2><?php esc_html_e( 'Reports', 'postindexer' ); ?></h2>
				<?php
				if ( count( $available_reports ) > 0 ) {
					...
					if ( count( $available_reports ) > 0 ) {
						...
						echo "<td valign='top'><a href='?page=reports&action=view-report&report=" . $available_report[1] . "' rel='permalink' class='edit'>" . esc_html__( 'View', 'postindexer' ) . "</a></td>";
						echo "</tr>";
					...
					?>
						<p><?php esc_html_e( 'No reports available.', 'postindexer' ); ?></p>
					<?php
				}
			break;
			//---------------------------------------------------//
			case "view-report":
				...
				?>
				<h2><a href="?page=reports" style="text-decoration:none;"><?php echo esc_html__( 'Reports', 'postindexer' ); ?></a> &raquo; <a href="?page=reports&action=view-report&report=<?php echo esc_attr($report_nicename); ?>" style="text-decoration:none;"><?php echo esc_html($report_name); ?></a></h2>
				<?php
